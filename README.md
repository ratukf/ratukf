...
### Tech Stack
- **Frontend**: HTML/CSS, JavaScript, TypeScript, React.js, Next.js, Tailwind, Material UI 
- **Backend**: Node.js, Express.js NestJS, PHP, Prisma, Postgre, MySQL, firebase

### Highlighted projects

- [Ecommerce Web](https://ecommerce-exclusive-one.vercel.app/)

A modern e-commerce web app to demonstrate online store features such as authentication, user profile management, payment simulation, product browse, cart page, and wishlist page built with React, TypeScript, Vite, Material UI, Firebase for backend services, and Node.js for bulk database management.
